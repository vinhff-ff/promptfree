...
import LinkNavigate from "../../components/custom/link";
import { useDrawer } from "../../components/custom/Drawer/context";
import ButtonCustom from "../../components/custom/BtnCustom/btn";

const CardMain = ({ id, img, name, description, topic, prompt }: any) => {
  ...
  return (
    <div className="card-normal-main" data-id={id}>
      <div className="card-normal__imagemain">
        <img src={img} alt={name} />
      </div>


      <div className="card-normal__contentmain">
